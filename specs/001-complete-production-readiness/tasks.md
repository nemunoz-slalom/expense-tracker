...
- [ ] T046 [P] [US3] Write creation and paid message formatting plus false-to-true transition-guard unit tests in `server/__tests__/unit/notification.service.test.js`
- [ ] T047 [P] [US3] Write stubbed-Telegram notify, missing-service, missing-credential, delivery-failure, and duplicate-paid integration tests in `server/__tests__/integration/notifications.test.js`
